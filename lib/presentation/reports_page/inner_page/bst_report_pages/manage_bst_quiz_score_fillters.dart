...
class ManageBSTQuizScoreFilter extends StatefulWidget {
  String? manageBSTReportListDataModel;
  bool isFiltered;
  String searchText;
  final Function(
    bool isFiltered,
  ) onSelectFilter;
  ManageBSTQuizScoreFilter(
    this.searchText,
  ...
  @override
  _ManageBSTQuizScoreFilterState createState() => _ManageBSTQuizScoreFilterState();
}

class _ManageBSTQuizScoreFilterState extends State<ManageBSTQuizScoreFilter> {
  ...
  List<MBSTQWingsModel?>? _wingItems = [];
  MBSTQWingsModel? _selectedWing;

  List<MBSTQRegionsModel?>? _regionItems = [];
  MBSTQRegionsModel? _selectedRegion;

  List<MBSTQCentersModel?>? _centerItems = [];
  List<MBSTQCentersModel?>? _regionWiseCenters = [];
  MBSTQCentersModel? _selectedCenter;

  List<MBSTQGroupListModel?>? _userGroupItems = [];
  MBSTQGroupListModel? _selectedUserGroup;

  List<String?>? _subGroupItems = [];
  String? _selectedSubGroup;

  List<MBSTQSchoolListModel?>? _schoolYearItems = [];
  MBSTQSchoolListModel? _selectedSchoolYear;
  ...
  void initState() {
    ...
    if (paramsBloc is ManageBSTQuizScoreFiltersState) {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<ManageBstAttendanceReportBloc>(context).state.maybeWhen(
        manageBSTQuizScore: (manageBSTQuizScoreModel, l) {
          if (manageBSTQuizScoreModel != null) {
            _wingItems = manageBSTQuizScoreModel.search_filter!.wings;
            if ((_wingItems != null && _wingItems!.length > 0)) {
              final regionIndex = _wingItems!.indexWhere((element) =>
                  element!.id.toString() ==
                  Utils().nullSafeString(
                      manageBSTQuizScoreModel.search_filter!.bst_fall_spring_report_data!.report_wing_id));
              if (regionIndex >= 0) {
            ...
            _regionItems = manageBSTQuizScoreModel.search_filter!.regions;
            if ((_regionItems != null && _regionItems!.length > 0)) {
              final regionIndex = _regionItems!.indexWhere((element) =>
                  element!.id.toString() ==
                  Utils()
                      .nullSafeString(manageBSTQuizScoreModel.search_filter!.bst_fall_spring_report_data!.region_id));
              if (regionIndex >= 0) {
            ...
            _centerItems = manageBSTQuizScoreModel.search_filter!.centers;
              ...
              if (_centerItems != null) {
                ...
                if ((_regionWiseCenters != null && _regionWiseCenters!.length > 0)) {
                  final centerIndex = _regionWiseCenters!.indexWhere((element) =>
                      element!.id.toString() ==
                      Utils().nullSafeString(
                          manageBSTQuizScoreModel.search_filter!.bst_fall_spring_report_data!.host_center_id));
                  if (centerIndex >= 0) {
            ...
            _userGroupItems = manageBSTQuizScoreModel.search_filter!.grouplist;
            ...
            _schoolYearItems = manageBSTQuizScoreModel.search_filter!.school_list;
            ...
            _strReportType =
                Utils().nullSafeString(manageBSTQuizScoreModel.search_filter!.bst_fall_spring_report_data!.name);
            _reportType.text = _strReportType;

            _strYear =
                Utils().nullSafeString(manageBSTQuizScoreModel.search_filter!.bst_fall_spring_report_data!.report_year);
            _year.text = _strYear;
                        ...
                        onPressed: () {
                          ...
                          if (_isFiltered) {
                            ...
                            String isForEditMode() {
                              ...
                              if (_strSelectedSearchUserId.isNotEmpty) {
                                return "2";
                              }

                              if (_strSelectedGroup.isNotEmpty) {
                                return "2";
                              }

                              if (_strSelectedSubGroup.isNotEmpty) {
                                return "2";
                              }

                              if (_strSelectedSchoolYear.isNotEmpty) {
                                return "2";
                              }
                            ...
                            if (widget.searchText.isNotEmpty) {
                              BlocProvider.of<ManageBstAttendanceReportBloc>(context)
                                ...
                                context,
                                widget.manageBSTReportListDataModel!,
                                isForEditMode(),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MBSTQWingsModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MBSTQRegionsModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MBSTQCentersModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MBSTQGroupListModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MBSTQSchoolListModel>(

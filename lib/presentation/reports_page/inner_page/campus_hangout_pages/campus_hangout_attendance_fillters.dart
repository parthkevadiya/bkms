...
class SCHAFilter extends StatefulWidget {
  final SubmitCampusHangoutAttendanceModel? submitCampusHangoutAttendanceModel;

  const SCHAFilter(this.submitCampusHangoutAttendanceModel, {Key? key}) : super(key: key);

  @override
  _SCHAFilterState createState() => _SCHAFilterState();
}

class _SCHAFilterState extends State<SCHAFilter> {
  List<SCHSchoolListModel?>? _schoolYearItems = [];
  SCHSchoolListModel? _selectedSchoolYear;
  ...
  void initState() {
    ...
    if (widget.submitCampusHangoutAttendanceModel != null) {
      _schoolYearItems = widget.submitCampusHangoutAttendanceModel!.school_list;
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<SCHSchoolListModel>(

...
class KST1On1MentoringInteractionDetails extends StatefulWidget {
  static String id = "kst1On1MentoringInteractionDetails";
  static String path = "${Manage1On1Mentoring.path}/$id";

  @override
  _KST1On1MentoringInteractionDetailsState createState() => _KST1On1MentoringInteractionDetailsState();
}

class _KST1On1MentoringInteractionDetailsState extends State<KST1On1MentoringInteractionDetails>
  ...
  K1On1MDataModel? _kst1On1MentoringDataModel;
  ...
  void initState() {
    ...
    if (paramsBloc is KSTReportDetailsState) {
      ...
      _kst1On1MentoringDataModel = paramsBloc.kst1On1MentoringDataModel;
    }

    //FOR ADD SELECTED ITEMS
    BlocProvider.of<ParamsBloc>(context)
        .add(KSTReportDetailsEvent(_kstReportItem!, _manageKSTReportListDataModel, null, _kst1On1MentoringDataModel));
    ...
    BlocProvider.of<KSTDataUpdateBloc>(context).add(KSTDataUpdateEvent.k1On1MentoringInteractionDetails(
      ...
      Utils().nullSafeString(_kst1On1MentoringDataModel!.id),
    ));
  }
                                                ...
                                                itemBuilder: (BuildContext context, int index) {
                                                  return GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        if (!currentItem.fields![fieldIndex]!.is_readonly!) {
                                                          var selectedDropdownItem = options[index] as K1On1MIDOptions;
                                                          List<K1On1MIDOptions?>? selectedDropdownItems = [];
                                                          selectedDropdownItems.add(selectedDropdownItem);
                                                          _interactionLogDataItems![parentIndex]!
                                                              .fields![fieldIndex]!

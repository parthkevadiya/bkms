...
class Add1On1MentoringInteraction extends StatefulWidget {
  static String id = "add1On1MentoringInteraction";
  static String path = "${Manage1On1Mentoring.path}/$id";

  @override
  _Add1On1MentoringInteractionState createState() => _Add1On1MentoringInteractionState();
}

class _Add1On1MentoringInteractionState extends State<Add1On1MentoringInteraction> with TickerProviderStateMixin {
  List<K1On1MIDFormAFieldsModel?>? _interactionLogDataItems = [];
  List<Add1On1MentoringFormRequestModel> _add1On1MentoringFormRequestModel = [];
  ...
  void initState() {
    ...
    BlocProvider.of<KSTDataUpdateBloc>(context).add(KSTDataUpdateEvent.k1On1MentoringInteractionDetails(
      context,
      ...
      listeners: [
        BlocListener<KSTDataUpdateBloc, KSTDataUpdateState>(
          listener: (context, state) {
            ...
            state.maybeWhen(
                k1On1MentoringInteractionDetails: (k1On1MentoringInteractionDetailsModel) {
                  if (k1On1MentoringInteractionDetailsModel != null) {
                    if (k1On1MentoringInteractionDetailsModel.form_fields != null) {
                      _interactionLogDataItems = k1On1MentoringInteractionDetailsModel.form_fields;
                    }
                  }
                },
                addKST1On1MentoringForm: (addKST1On1MentoringFormModel) {
                  if (addKST1On1MentoringFormModel != null) {
                    if (!addKST1On1MentoringFormModel.has_error!) {
                      //FOR REFRESH 1ON1 MENTORING LIST
                      BlocProvider.of<ParamsBloc>(context).add(KST1On1MentoringListRefreshEvent(true));
                              ...
                              children: List.generate(currentItem.fields!.length, (fieldIndex) {
                                ...
                                if (field != null) {
                                  if (field.type == Constant.brftMULTI_SELECT) {
                                    ...
                                    if (selectedItem is List<K1On1MIDOptions?>?) {
                                      ...
                                      List<K1On1MIDOptions?>? blankOptions = [];
                                              ...
                                              return GestureDetector(
                                                onTap: () {
                                                  if (!currentItem.fields![fieldIndex]!.is_readonly!) {
                                                    setState(() {
                                                      var isForAdd = true;
                                                      List<K1On1MIDOptions?>? previousSelectedItems = [];
                                                      if (currentItem.fields![fieldIndex]!.selected!
                                                          is List<K1On1MIDOptions?>?) {
                                                ...
                                                child: DropdownButton(
                                                  ...
                                                  onChanged: (currentItem.fields![fieldIndex]!.is_readonly!)
                                                      ...
                                                      : (newValue) {
                                                          if (!currentItem.fields![fieldIndex]!.is_readonly!) {
                                                            setState(() {
                                                              var selectedDropdownItem = newValue as K1On1MIDOptions;
                                                              List<K1On1MIDOptions?>? selectedDropdownItems = [];
                                                    ...
                                                    return GestureDetector(
                                                      onTap: () {
                                                        setState(() {
                                                          if (!currentItem.fields![fieldIndex]!.is_readonly!) {
                                                            var selectedDropdownItem =
                                                                options[index] as K1On1MIDOptions;
                                                            List<K1On1MIDOptions?>? selectedDropdownItems = [];
                                                            selectedDropdownItems.add(selectedDropdownItem);
                                                            _interactionLogDataItems![parentIndex]!
                                                                .fields![fieldIndex]!
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  _add1On1MentoringFormRequestModel = [];
                                  _add1On1MentoringFormRequestModel.add(Add1On1MentoringFormRequestModel(
                                      "login_user_type",
                                  ...
                                  if (validateInteractionsInformation()) {
                                    setState(() {
                                      ...
                                      BlocProvider.of<KSTDataUpdateBloc>(context).add(
                                          KSTDataUpdateEvent.addKST1On1MentoringForm(
                                              context, _add1On1MentoringFormRequestModel));
                                    });
                                  }
                                },
                                child: Padding(
        ...
        for (int fieldIndex = 0; fieldIndex < currentItem.fields!.length; fieldIndex++) {
          ...
          if (field.type == Constant.brftMULTI_SELECT) {
            if (field.selected != null) {
              ...
              _add1On1MentoringFormRequestModel.add(
                  Add1On1MentoringFormRequestModel(Utils().nullSafeString(field.name), null, multipleValues, null));
            }

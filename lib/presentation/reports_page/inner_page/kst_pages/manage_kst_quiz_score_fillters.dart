...
class ManageKSTQuizScoreFilter extends StatefulWidget {
  ...
  @override
  _ManageKSTQuizScoreFilterState createState() => _ManageKSTQuizScoreFilterState();
}

class _ManageKSTQuizScoreFilterState extends State<ManageKSTQuizScoreFilter> {
  ...
  List<MKSTQWingsModel?>? _wingItems = [];
  MKSTQWingsModel? _selectedWing;

  List<MKSTQRegionsModel?>? _regionItems = [];
  MKSTQRegionsModel? _selectedRegion;

  List<MKSTQCentersModel?>? _centerItems = [];
  List<MKSTQCentersModel?>? _regionWiseCenters = [];
  MKSTQCentersModel? _selectedCenter;

  List<MKSTQGroupListModel?>? _userGroupItems = [];
  MKSTQGroupListModel? _selectedUserGroup;

  List<String?>? _subGroupItems = [];
  String? _selectedSubGroup;

  List<MKSTQSchoolListModel?>? _schoolYearItems = [];
  MKSTQSchoolListModel? _selectedSchoolYear;
  ...
  void initState() {
    ...
    if (paramsBloc is ManageKSTQuizScoreFiltersState) {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<ManageKSTReportBloc>(context).state.maybeWhen(
        manageKSTQuizScore: (manageKSTQuizScoreModel, l) {
          if (manageKSTQuizScoreModel != null) {
            _wingItems = manageKSTQuizScoreModel.kst_quiz_score_filter!.wings;
            if ((_wingItems != null && _wingItems!.length > 0)) {
              final regionIndex = _wingItems!.indexWhere((element) =>
                  element!.id.toString() ==
                  Utils().nullSafeString(
                      manageKSTQuizScoreModel.kst_quiz_score_filter!.kst_manage_report_data!.report_wing_id));
              if (regionIndex >= 0) {
            ...
            _regionItems = manageKSTQuizScoreModel.kst_quiz_score_filter!.regions;
            if ((_regionItems != null && _regionItems!.length > 0)) {
              final regionIndex = _regionItems!.indexWhere((element) =>
                  element!.id.toString() ==
                  Utils().nullSafeString(
                      manageKSTQuizScoreModel.kst_quiz_score_filter!.kst_manage_report_data!.region_id));
              if (regionIndex >= 0) {
            ...
            _centerItems = manageKSTQuizScoreModel.kst_quiz_score_filter!.centers;
              ...
              if (_centerItems != null) {
                ...
                if ((_regionWiseCenters != null && _regionWiseCenters!.length > 0)) {
                  final centerIndex = _regionWiseCenters!.indexWhere((element) =>
                      element!.id.toString() ==
                      Utils().nullSafeString(
                          manageKSTQuizScoreModel.kst_quiz_score_filter!.kst_manage_report_data!.host_center_id));
                  if (centerIndex >= 0) {
            ...
            _userGroupItems = manageKSTQuizScoreModel.kst_quiz_score_filter!.grouplist;
            ...
            _schoolYearItems = manageKSTQuizScoreModel.kst_quiz_score_filter!.school_list;
            ...
            _strReportType =
                Utils().nullSafeString(manageKSTQuizScoreModel.kst_quiz_score_filter!.kst_manage_report_data!.name);
            _reportType.text = _strReportType;

            _strYear = Utils()
                .nullSafeString(manageKSTQuizScoreModel.kst_quiz_score_filter!.kst_manage_report_data!.report_year);
            _year.text = _strYear;
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MKSTQWingsModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MKSTQRegionsModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MKSTQCentersModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MKSTQGroupListModel>(
                          ...
                          Padding(
                            ...
                            child: Container(
                              decoration:
                                  BoxDecoration(color: Color(0xffF2F2F2), borderRadius: BorderRadius.circular(3.6)),
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<MKSTQSchoolListModel>(

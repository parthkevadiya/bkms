...
part 'manage_kst_quiz_score_request_model.g.dart';

@JsonSerializable()
class ManageKSTQuizScoreRequestModel /*extends Equatable*/ {
  ...
  ManageKSTQuizScoreRequestModel(
  ...
  factory ManageKSTQuizScoreRequestModel.fromJson(Map<String, dynamic> json) =>
      _$ManageKSTQuizScoreRequestModelFromJson(json);

  Map<String, dynamic> toJson() => _$ManageKSTQuizScoreRequestModelToJson(this);
